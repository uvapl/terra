This directory includes files from the [Pyodide project](https://github.com/pyodide/pyodide), which is licensed under the [Mozilla Public License Version 2.0 (MPL 2.0)](https://www.mozilla.org/en-US/MPL/2.0/).
